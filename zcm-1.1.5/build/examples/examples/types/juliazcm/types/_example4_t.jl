...
mutable struct example4_t <: ZCM.AbstractZcmType
    ...
    timestamp                     ::Int64
    p                             ::ZCM.AbstractZcmType # juliazcm.types.test_package.example3_t
    ...
    function example4_t()
        ...
        self.timestamp = 0
        self.p = __basemodule.types.test_package.example3_t()
...
function ZCM._get_hash_recursive(::Type{example4_t}, parents::Array{String})
    ...
    hash::UInt64 = 0x4541e0c6b43d6b19 + reinterpret(UInt64, ZCM._get_hash_recursive(__basemodule.types.test_package.example3_t, newparents))
...
function ZCM._encode_one(msg::example4_t, buf)
    ...
    @assert isa(msg.p, __basemodule.types.test_package.example3_t) "Msg of type `example4_t` requires field `p` to be of type `test_package.example3_t`"
...
function ZCM._decode_one(::Type{example4_t}, buf)
    ...
    msg.p = ZCM._decode_one(__basemodule.types.test_package.example3_t,buf)
    return msg
end
