...
mutable struct arrays_t <: ZCM.AbstractZcmType
    ...
    nonprim_onedim_static         ::Array{ZCM.AbstractZcmType,1} # juliazcm.types.example_t
    nonprim_onedim_dynamic        ::Array{ZCM.AbstractZcmType,1} # juliazcm.types.example_t
    nonprim_twodim_static_static  ::Array{ZCM.AbstractZcmType,2} # juliazcm.types.example_t
    nonprim_twodim_static_dynamic ::Array{ZCM.AbstractZcmType,2} # juliazcm.types.example_t
    nonprim_twodim_dynamic_static ::Array{ZCM.AbstractZcmType,2} # juliazcm.types.example_t
    nonprim_twodim_dynamic_dynamic::Array{ZCM.AbstractZcmType,2} # juliazcm.types.example_t
    ...
    function arrays_t()
        ...
        self.nonprim_onedim_static = [ __basemodule.types.example_t() for dim0=1:3 ]
        self.nonprim_onedim_dynamic = [ __basemodule.types.example_t() for dim0=1:self.n ]
        self.nonprim_twodim_static_static = [ __basemodule.types.example_t() for dim0=1:3, dim1=1:3 ]
        self.nonprim_twodim_static_dynamic = [ __basemodule.types.example_t() for dim0=1:3, dim1=1:self.n ]
        self.nonprim_twodim_dynamic_static = [ __basemodule.types.example_t() for dim0=1:self.n, dim1=1:3 ]
        self.nonprim_twodim_dynamic_dynamic = [ __basemodule.types.example_t() for dim0=1:self.m, dim1=1:self.n ]
...
function ZCM._get_hash_recursive(::Type{arrays_t}, parents::Array{String})
    ...
    hash::UInt64 = 0x6ebeacdee9743f6b + reinterpret(UInt64, ZCM._get_hash_recursive(__basemodule.types.example_t, newparents)) + reinterpret(UInt64, ZCM._get_hash_recursive(__basemodule.types.example_t, newparents)) + reinterpret(UInt64, ZCM._get_hash_recursive(__basemodule.types.example_t, newparents)) + reinterpret(UInt64, ZCM._get_hash_recursive(__basemodule.types.example_t, newparents)) + reinterpret(UInt64, ZCM._get_hash_recursive(__basemodule.types.example_t, newparents)) + reinterpret(UInt64, ZCM._get_hash_recursive(__basemodule.types.example_t, newparents))
...
function ZCM._encode_one(msg::arrays_t, buf)
    ...
    for i0=1:3
        @assert isa(msg.nonprim_onedim_static[i0], __basemodule.types.example_t) "Msg of type `arrays_t` requires field `msg.nonprim_onedim_static[i0]` to be of type `example_t`"
    ...
    for i0=1:msg.n
        @assert isa(msg.nonprim_onedim_dynamic[i0], __basemodule.types.example_t) "Msg of type `arrays_t` requires field `msg.nonprim_onedim_dynamic[i0]` to be of type `example_t`"
    ...
    for i0=1:3
        for i1=1:3
            @assert isa(msg.nonprim_twodim_static_static[i0,i1], __basemodule.types.example_t) "Msg of type `arrays_t` requires field `msg.nonprim_twodim_static_static[i0,i1]` to be of type `example_t`"
    ...
    for i0=1:3
        for i1=1:msg.n
            @assert isa(msg.nonprim_twodim_static_dynamic[i0,i1], __basemodule.types.example_t) "Msg of type `arrays_t` requires field `msg.nonprim_twodim_static_dynamic[i0,i1]` to be of type `example_t`"
    ...
    for i0=1:msg.n
        for i1=1:3
            @assert isa(msg.nonprim_twodim_dynamic_static[i0,i1], __basemodule.types.example_t) "Msg of type `arrays_t` requires field `msg.nonprim_twodim_dynamic_static[i0,i1]` to be of type `example_t`"
    ...
    for i0=1:msg.m
        for i1=1:msg.n
            @assert isa(msg.nonprim_twodim_dynamic_dynamic[i0,i1], __basemodule.types.example_t) "Msg of type `arrays_t` requires field `msg.nonprim_twodim_dynamic_dynamic[i0,i1]` to be of type `example_t`"
...
function ZCM._decode_one(::Type{arrays_t}, buf)
    ...
    for i0=1:3
        msg.nonprim_onedim_static[i0] = ZCM._decode_one(__basemodule.types.example_t,buf)
    end
    @static if VERSION < v"0.7.0-"
    ...
    for i0=1:msg.n
        msg.nonprim_onedim_dynamic[i0] = ZCM._decode_one(__basemodule.types.example_t,buf)
    end
    @static if VERSION < v"0.7.0-"
    ...
    for i0=1:3
        for i1=1:3
            msg.nonprim_twodim_static_static[i0,i1] = ZCM._decode_one(__basemodule.types.example_t,buf)
        end
    end
    @static if VERSION < v"0.7.0-"
    ...
    for i0=1:3
        for i1=1:msg.n
            msg.nonprim_twodim_static_dynamic[i0,i1] = ZCM._decode_one(__basemodule.types.example_t,buf)
        end
    end
    @static if VERSION < v"0.7.0-"
    ...
    for i0=1:msg.n
        for i1=1:3
            msg.nonprim_twodim_dynamic_static[i0,i1] = ZCM._decode_one(__basemodule.types.example_t,buf)
        end
    end
    @static if VERSION < v"0.7.0-"
    ...
    for i0=1:msg.m
        for i1=1:msg.n
            msg.nonprim_twodim_dynamic_dynamic[i0,i1] = ZCM._decode_one(__basemodule.types.example_t,buf)
        end
    end
    return msg
end
