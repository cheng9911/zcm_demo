...
mutable struct packaged2_t <: ZCM.AbstractZcmType
    ...
    packaged                      ::Bool
    e                             ::ZCM.AbstractZcmType # juliazcm.types.example4_t
    ...
    function packaged2_t()
        ...
        self.packaged = false
        self.e = __basemodule.types.example4_t()
...
function ZCM._get_hash_recursive(::Type{packaged2_t}, parents::Array{String})
    ...
    hash::UInt64 = 0x471a628ba5e54d99 + reinterpret(UInt64, ZCM._get_hash_recursive(__basemodule.types.example4_t, newparents))
...
function ZCM._encode_one(msg::packaged2_t, buf)
    ...
    @assert isa(msg.e, __basemodule.types.example4_t) "Msg of type `test_package.packaged2_t` requires field `e` to be of type `example4_t`"
...
function ZCM._decode_one(::Type{packaged2_t}, buf)
    ...
    msg.e = ZCM._decode_one(__basemodule.types.example4_t,buf)
    return msg
end
