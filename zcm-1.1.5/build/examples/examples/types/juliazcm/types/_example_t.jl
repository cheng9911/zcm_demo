...
mutable struct example_t <: ZCM.AbstractZcmType
    ...
    nExamples1                    ::Int32
    nExamples2                    ::Int32
    subExamples                   ::Array{ZCM.AbstractZcmType,2} # juliazcm.types.example_t
    ...
    function example_t()
        ...
        self.nExamples1 = 0
        self.nExamples2 = 0
        self.subExamples = [ __basemodule.types.example_t() for dim0=1:self.nExamples1, dim1=1:self.nExamples2 ]
...
function ZCM._get_hash_recursive(::Type{example_t}, parents::Array{String})
    ...
    hash::UInt64 = 0x1939f4d104c8d2f8 + reinterpret(UInt64, ZCM._get_hash_recursive(__basemodule.types.example_t, newparents))
...
function ZCM._encode_one(msg::example_t, buf)
    ...
    for i0=1:msg.nExamples1
        for i1=1:msg.nExamples2
            @assert isa(msg.subExamples[i0,i1], __basemodule.types.example_t) "Msg of type `example_t` requires field `msg.subExamples[i0,i1]` to be of type `example_t`"
    ...
    @assert size(msg.bitfield2,1)==4 "Msg of type `example_t` requires field `bitfield2` dimension `1` to be size `4`"
    for i0=1:4
...
function ZCM._decode_one(::Type{example_t}, buf)
    ...
    for i0=1:msg.nExamples1
        for i1=1:msg.nExamples2
            msg.subExamples[i0,i1] = ZCM._decode_one(__basemodule.types.example_t,buf)
        end
    end
    @static if VERSION < v"0.7.0-"
