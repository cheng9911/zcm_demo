...
public final class unpackaged_t implements zcm.zcm.ZCMEncodable
{
    ...
    {
        if (classes.contains(javazcm.types.unpackaged_t.class))
            return 0L;
 
        classes.add(javazcm.types.unpackaged_t.class);
    ...
    public static javazcm.types.unpackaged_t _decodeRecursiveFactory(ZCMDataInputStream ins) throws IOException
    {
        javazcm.types.unpackaged_t o = new javazcm.types.unpackaged_t();
    ...
    public javazcm.types.unpackaged_t copy()
    {
        javazcm.types.unpackaged_t outobj = new javazcm.types.unpackaged_t();
        outobj.x = this.x;
