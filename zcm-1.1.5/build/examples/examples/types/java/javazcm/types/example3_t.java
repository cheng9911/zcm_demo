...
public final class example3_t implements zcm.zcm.ZCMEncodable
{
    ...
    {
        if (classes.contains(javazcm.types.example3_t.class))
            return 0L;
 
        classes.add(javazcm.types.example3_t.class);
    ...
    public static javazcm.types.example3_t _decodeRecursiveFactory(ZCMDataInputStream ins) throws IOException
    {
        javazcm.types.example3_t o = new javazcm.types.example3_t();
    ...
    public javazcm.types.example3_t copy()
    {
        javazcm.types.example3_t outobj = new javazcm.types.example3_t();
