...
public final class demo_t implements zcm.zcm.ZCMEncodable
{
    ...
    {
        if (classes.contains(javazcm.types.demo_t.class))
            return 0L;
 
        classes.add(javazcm.types.demo_t.class);
    ...
    public static javazcm.types.demo_t _decodeRecursiveFactory(ZCMDataInputStream ins) throws IOException
    {
        javazcm.types.demo_t o = new javazcm.types.demo_t();
    ...
    public javazcm.types.demo_t copy()
    {
        javazcm.types.demo_t outobj = new javazcm.types.demo_t();
