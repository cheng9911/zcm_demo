...
public final class demo_t implements zcm.zcm.ZCMEncodable
{
    ...
    public static final long ZCM_FINGERPRINT_BASE = 0x19e1f2954f09cb22L;
    ...
    {
        if (classes.contains(javazcmtypespfx.example.zcmtypes.demo_t.class))
            return 0L;
 
        classes.add(javazcmtypespfx.example.zcmtypes.demo_t.class);
    ...
    public demo_t(byte[] data) throws IOException
    {
        this(new ZCMDataInputStream(data));
    }
 
    public demo_t(ZCMDataInputStream ins) throws IOException
    {
    ...
    public static javazcmtypespfx.example.zcmtypes.demo_t _decodeRecursiveFactory(ZCMDataInputStream ins) throws IOException
    {
        javazcmtypespfx.example.zcmtypes.demo_t o = new javazcmtypespfx.example.zcmtypes.demo_t();
    ...
    public javazcmtypespfx.example.zcmtypes.demo_t copy()
    {
        javazcmtypespfx.example.zcmtypes.demo_t outobj = new javazcmtypespfx.example.zcmtypes.demo_t();
