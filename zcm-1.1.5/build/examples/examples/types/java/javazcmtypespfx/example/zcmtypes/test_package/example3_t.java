...
public final class example3_t implements zcm.zcm.ZCMEncodable
{
    ...
    {
        if (classes.contains(javazcmtypespfx.example.zcmtypes.test_package.example3_t.class))
            return 0L;
 
        classes.add(javazcmtypespfx.example.zcmtypes.test_package.example3_t.class);
    ...
    public static javazcmtypespfx.example.zcmtypes.test_package.example3_t _decodeRecursiveFactory(ZCMDataInputStream ins) throws IOException
    {
        javazcmtypespfx.example.zcmtypes.test_package.example3_t o = new javazcmtypespfx.example.zcmtypes.test_package.example3_t();
    ...
    public javazcmtypespfx.example.zcmtypes.test_package.example3_t copy()
    {
        javazcmtypespfx.example.zcmtypes.test_package.example3_t outobj = new javazcmtypespfx.example.zcmtypes.test_package.example3_t();
