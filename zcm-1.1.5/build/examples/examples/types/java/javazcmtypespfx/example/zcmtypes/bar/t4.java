...
package javazcmtypespfx.example.zcmtypes.bar;
...
public final class t4 implements zcm.zcm.ZCMEncodable
{
    ...
    {
        if (classes.contains(javazcmtypespfx.example.zcmtypes.bar.t4.class))
            return 0L;
 
        classes.add(javazcmtypespfx.example.zcmtypes.bar.t4.class);
    ...
    public static javazcmtypespfx.example.zcmtypes.bar.t4 _decodeRecursiveFactory(ZCMDataInputStream ins) throws IOException
    {
        javazcmtypespfx.example.zcmtypes.bar.t4 o = new javazcmtypespfx.example.zcmtypes.bar.t4();
    ...
    public javazcmtypespfx.example.zcmtypes.bar.t4 copy()
    {
        javazcmtypespfx.example.zcmtypes.bar.t4 outobj = new javazcmtypespfx.example.zcmtypes.bar.t4();
