...
public final class example_t implements zcm.zcm.ZCMEncodable
{
    ...
    public javazcmtypespfx.example.zcmtypes.example_t subExamples[][];
    ...
    {
        if (classes.contains(javazcmtypespfx.example.zcmtypes.example_t.class))
            return 0L;
 
        classes.add(javazcmtypespfx.example.zcmtypes.example_t.class);
    ...
    public static javazcmtypespfx.example.zcmtypes.example_t _decodeRecursiveFactory(ZCMDataInputStream ins) throws IOException
    {
        javazcmtypespfx.example.zcmtypes.example_t o = new javazcmtypespfx.example.zcmtypes.example_t();
    ...
    public void _decodeRecursive(ZCMDataInputStream ins) throws IOException
    {
        ...
        this.subExamples = new javazcmtypespfx.example.zcmtypes.example_t[(int) nExamples1][(int) nExamples2];
        for (int a = 0; a < this.nExamples1; ++a) {
            for (int b = 0; b < this.nExamples2; ++b) {
                this.subExamples[a][b] = javazcmtypespfx.example.zcmtypes.example_t._decodeRecursiveFactory(ins);
            }
        }
    ...
    public javazcmtypespfx.example.zcmtypes.example_t copy()
    {
        javazcmtypespfx.example.zcmtypes.example_t outobj = new javazcmtypespfx.example.zcmtypes.example_t();
        ...
        outobj.subExamples = new javazcmtypespfx.example.zcmtypes.example_t[(int) nExamples1][(int) nExamples2];
        for (int a = 0; a < this.nExamples1; ++a) {
            for (int b = 0; b < this.nExamples2; ++b) {
