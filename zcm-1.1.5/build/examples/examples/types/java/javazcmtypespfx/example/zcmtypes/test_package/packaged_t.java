...
public final class packaged_t implements zcm.zcm.ZCMEncodable
{
    ...
    public javazcmtypespfx.example.zcmtypes.test_package.packaged2_t a;
    ...
    {
        if (classes.contains(javazcmtypespfx.example.zcmtypes.test_package.packaged_t.class))
            return 0L;
 
        classes.add(javazcmtypespfx.example.zcmtypes.test_package.packaged_t.class);
        long hash = ZCM_FINGERPRINT_BASE
             + javazcmtypespfx.example.zcmtypes.test_package.packaged2_t._hashRecursive(classes)
            ;
    ...
    public static javazcmtypespfx.example.zcmtypes.test_package.packaged_t _decodeRecursiveFactory(ZCMDataInputStream ins) throws IOException
    {
        javazcmtypespfx.example.zcmtypes.test_package.packaged_t o = new javazcmtypespfx.example.zcmtypes.test_package.packaged_t();
    ...
    public void _decodeRecursive(ZCMDataInputStream ins) throws IOException
    {
        ...
        this.a = javazcmtypespfx.example.zcmtypes.test_package.packaged2_t._decodeRecursiveFactory(ins);
 
    }
 
    public javazcmtypespfx.example.zcmtypes.test_package.packaged_t copy()
    {
        javazcmtypespfx.example.zcmtypes.test_package.packaged_t outobj = new javazcmtypespfx.example.zcmtypes.test_package.packaged_t();
