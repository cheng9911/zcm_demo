...
const __example_zcmtypes_unpackaged_t_hash = Ref(Int64(0))
function ZCM._get_hash_recursive(::Type{unpackaged_t}, parents::Array{String})
    if __example_zcmtypes_unpackaged_t_hash[] != 0; return __example_zcmtypes_unpackaged_t_hash[]; end
    if "example_zcmtypes_unpackaged_t" in parents; return 0; end
    hash::UInt64 = 0xc6ee746a491f75db
    hash = (hash << 1) + ((hash >>> 63) & 0x01)
    __example_zcmtypes_unpackaged_t_hash[] = reinterpret(Int64, hash)
