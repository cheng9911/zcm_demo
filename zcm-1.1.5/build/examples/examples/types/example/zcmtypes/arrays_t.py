...
from example.zcmtypes.example_t import example_t as example_zcmtypes_example_t
...
class arrays_t(object):
    ...
    def __init__(self):
        ...
        self.nonprim_onedim_static = [ example_zcmtypes_example_t() for dim0 in range(3) ]
        self.nonprim_onedim_dynamic = []
        self.nonprim_twodim_static_static = [ [ example_zcmtypes_example_t() for dim1 in range(3) ] for dim0 in range(3) ]
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(3):
            assert self.nonprim_onedim_static[i0]._get_packed_fingerprint() == example_zcmtypes_example_t._get_packed_fingerprint()
            self.nonprim_onedim_static[i0]._encode_one(buf)
        for i0 in range(self.n):
            assert self.nonprim_onedim_dynamic[i0]._get_packed_fingerprint() == example_zcmtypes_example_t._get_packed_fingerprint()
            self.nonprim_onedim_dynamic[i0]._encode_one(buf)
        for i0 in range(3):
            for i1 in range(3):
                assert self.nonprim_twodim_static_static[i0][i1]._get_packed_fingerprint() == example_zcmtypes_example_t._get_packed_fingerprint()
                self.nonprim_twodim_static_static[i0][i1]._encode_one(buf)
        for i0 in range(3):
            for i1 in range(self.n):
                assert self.nonprim_twodim_static_dynamic[i0][i1]._get_packed_fingerprint() == example_zcmtypes_example_t._get_packed_fingerprint()
                self.nonprim_twodim_static_dynamic[i0][i1]._encode_one(buf)
        for i0 in range(self.n):
            for i1 in range(3):
                assert self.nonprim_twodim_dynamic_static[i0][i1]._get_packed_fingerprint() == example_zcmtypes_example_t._get_packed_fingerprint()
                self.nonprim_twodim_dynamic_static[i0][i1]._encode_one(buf)
        for i0 in range(self.m):
            for i1 in range(self.n):
                assert self.nonprim_twodim_dynamic_dynamic[i0][i1]._get_packed_fingerprint() == example_zcmtypes_example_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        for i0 in range(3):
            self.nonprim_onedim_static.append(example_zcmtypes_example_t._decode_one(buf))
        self.nonprim_onedim_dynamic = []
        for i0 in range(self.n):
            self.nonprim_onedim_dynamic.append(example_zcmtypes_example_t._decode_one(buf))
        self.nonprim_twodim_static_static = []
        for i0 in range(3):
            self.nonprim_twodim_static_static.append ([])
            for i1 in range(3):
                self.nonprim_twodim_static_static[i0].append(example_zcmtypes_example_t._decode_one(buf))
        self.nonprim_twodim_static_dynamic = []
        for i0 in range(3):
            self.nonprim_twodim_static_dynamic.append ([])
            for i1 in range(self.n):
                self.nonprim_twodim_static_dynamic[i0].append(example_zcmtypes_example_t._decode_one(buf))
        self.nonprim_twodim_dynamic_static = []
        for i0 in range(self.n):
            self.nonprim_twodim_dynamic_static.append ([])
            for i1 in range(3):
                self.nonprim_twodim_dynamic_static[i0].append(example_zcmtypes_example_t._decode_one(buf))
        self.nonprim_twodim_dynamic_dynamic = []
        for i0 in range(self.m):
            self.nonprim_twodim_dynamic_dynamic.append ([])
            for i1 in range(self.n):
                self.nonprim_twodim_dynamic_dynamic[i0].append(example_zcmtypes_example_t._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x6ebeacdee9743f6b+ example_zcmtypes_example_t._get_hash_recursive(newparents)+ example_zcmtypes_example_t._get_hash_recursive(newparents)+ example_zcmtypes_example_t._get_hash_recursive(newparents)+ example_zcmtypes_example_t._get_hash_recursive(newparents)+ example_zcmtypes_example_t._get_hash_recursive(newparents)+ example_zcmtypes_example_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
