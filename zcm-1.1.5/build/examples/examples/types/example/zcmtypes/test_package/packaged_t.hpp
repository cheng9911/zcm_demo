...
#ifndef __example_zcmtypes_test_package_packaged_t_hpp__
#define __example_zcmtypes_test_package_packaged_t_hpp__

#include "types/example/zcmtypes/test_package/packaged2_t.hpp"
...
class packaged_t
{
    public:
        ...
        example::zcmtypes::test_package::packaged2_t a;
...
uint64_t packaged_t::_computeHash(const __zcm_hash_ptr* p)
{
    ...
    uint64_t hash = (uint64_t)0x26471757e1db6303LL +
         example::zcmtypes::test_package::packaged2_t::_computeHash(&cp);
