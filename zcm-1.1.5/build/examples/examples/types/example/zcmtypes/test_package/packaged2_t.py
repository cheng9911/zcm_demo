...
from example.zcmtypes.example4_t import example4_t as example_zcmtypes_example4_t
...
class packaged2_t(object):
    ...
    def __init__(self):
        self.packaged = False
        self.e = example_zcmtypes_example4_t()
    ...
    def _encode_one(self, buf):
        ...
        assert self.e._get_packed_fingerprint() == example_zcmtypes_example4_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.e = example_zcmtypes_example4_t._decode_one(buf)
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x471a628ba5e54d99+ example_zcmtypes_example4_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
